...
public class TableWidget extends AppWidgetProvider {
    ...
    public static String WIDGET_BUTTON = "dguplan_now_UPDATE_BUTTON";
    ...
    public void onReceive(Context context, Intent intent) {
        super.onReceive(context, intent);
            if(WIDGET_BUTTON.equals(intent.getAction())){
                ...
                ComponentName thisAppWidget = new ComponentName(context.getPackageName(), TableWidget.class.getName());
